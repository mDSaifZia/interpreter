...
def semantic_analysis_and_bytecode_gen(ast, output_file):
    checker = SemanticChecker()
    try:
        checker.check(ast)
        print("Semantic Analysis: PASS")
        generate_bytecode(ast, output_file)
...
def main():
    ...
    semantic_analysis_and_bytecode_gen(ast, output_file)  # Semantic analysis and bytecode generation
